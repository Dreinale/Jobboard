...
$url_api_create = "/api_job_board/users/create_comp";
//$id = $_GET['id'];
                ...
                <div class="col-md-12">
                    ...
                    <form action=<?=$api_url?> method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" class="form-control <?php echo (!empty($address_err)) ? 'is-invalid' : ''; ?>"><?php echo $description; ?></textarea>
